...
EJ7Segundo:     formato del fichero elf32-i386
...
0000118d <main>:
    ...
    1197:	e8 3f 00 00 00       	call   11db <__x86.get_pc_thunk.ax>
    ...
    11c4:	8b 54 24 5c          	mov    edx,DWORD PTR [esp+0x5c]
    11c8:	65 33 15 14 00 00 00 	xor    edx,DWORD PTR gs:0x14
    11cf:	74 05                	je     11d6 <main+0x49>
    11d1:	e8 7a 00 00 00       	call   1250 <__stack_chk_fail_local>
    11d6:	8b 7d fc             	mov    edi,DWORD PTR [ebp-0x4]
    11d9:	c9                   	leave  
    11da:	c3                   	ret    

000011db <__x86.get_pc_thunk.ax>:
    11db:	8b 04 24             	mov    eax,DWORD PTR [esp]
    11de:	c3                   	ret    
    11df:	90                   	nop
