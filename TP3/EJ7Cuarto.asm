...
EJ7Cuarto:     formato del fichero elf32-i386
...
00001050 <_start>:
    ...
    1066:	8d 83 50 d2 ff ff    	lea    eax,[ebx-0x2db0]
    106c:	50                   	push   eax
    106d:	8d 83 f0 d1 ff ff    	lea    eax,[ebx-0x2e10]
    1073:	50                   	push   eax
    1074:	51                   	push   ecx
    1075:	56                   	push   esi
...
0000118d <main>:
    ...
    1194:	83 ec 60             	sub    esp,0x60
    1197:	e8 47 00 00 00       	call   11e3 <__x86.get_pc_thunk.ax>
    119c:	05 64 2e 00 00       	add    eax,0x2e64
    11a1:	65 a1 14 00 00 00    	mov    eax,gs:0x14
    11a7:	89 44 24 5c          	mov    DWORD PTR [esp+0x5c],eax
    11ab:	31 c0                	xor    eax,eax
    11ad:	8d 54 24 0c          	lea    edx,[esp+0xc]
    11b1:	b8 00 00 00 00       	mov    eax,0x0
    11b6:	b9 14 00 00 00       	mov    ecx,0x14
    11bb:	89 d7                	mov    edi,edx
    11bd:	f3 ab                	rep stos DWORD PTR es:[edi],eax
    11bf:	c7 44 24 34 1e 00 00 	mov    DWORD PTR [esp+0x34],0x1e
    11c6:	00 
    11c7:	b8 00 00 00 00       	mov    eax,0x0
    11cc:	8b 54 24 5c          	mov    edx,DWORD PTR [esp+0x5c]
    11d0:	65 33 15 14 00 00 00 	xor    edx,DWORD PTR gs:0x14
    11d7:	74 05                	je     11de <main+0x51>
    11d9:	e8 82 00 00 00       	call   1260 <__stack_chk_fail_local>
    11de:	8b 7d fc             	mov    edi,DWORD PTR [ebp-0x4]
    11e1:	c9                   	leave  
    11e2:	c3                   	ret    
...
000011f0 <__libc_csu_init>:
    11f0:	55                   	push   ebp
    11f1:	57                   	push   edi
    11f2:	56                   	push   esi
    11f3:	53                   	push   ebx
    11f4:	e8 97 fe ff ff       	call   1090 <__x86.get_pc_thunk.bx>
    11f9:	81 c3 07 2e 00 00    	add    ebx,0x2e07
    11ff:	83 ec 0c             	sub    esp,0xc
    1202:	8b 6c 24 28          	mov    ebp,DWORD PTR [esp+0x28]
    1206:	e8 f5 fd ff ff       	call   1000 <_init>
    120b:	8d b3 f8 fe ff ff    	lea    esi,[ebx-0x108]
    1211:	8d 83 f4 fe ff ff    	lea    eax,[ebx-0x10c]
    1217:	29 c6                	sub    esi,eax
    1219:	c1 fe 02             	sar    esi,0x2
    121c:	74 1f                	je     123d <__libc_csu_init+0x4d>
    121e:	31 ff                	xor    edi,edi
    1220:	83 ec 04             	sub    esp,0x4
    1223:	55                   	push   ebp
    1224:	ff 74 24 2c          	push   DWORD PTR [esp+0x2c]
    1228:	ff 74 24 2c          	push   DWORD PTR [esp+0x2c]
    122c:	ff 94 bb f4 fe ff ff 	call   DWORD PTR [ebx+edi*4-0x10c]
    1233:	83 c7 01             	add    edi,0x1
    1236:	83 c4 10             	add    esp,0x10
    1239:	39 fe                	cmp    esi,edi
    123b:	75 e3                	jne    1220 <__libc_csu_init+0x30>
    123d:	83 c4 0c             	add    esp,0xc
    1240:	5b                   	pop    ebx
    1241:	5e                   	pop    esi
    1242:	5f                   	pop    edi
    1243:	5d                   	pop    ebp
    1244:	c3                   	ret    
    1245:	8d b4 26 00 00 00 00 	lea    esi,[esi+eiz*1+0x0]
    124c:	8d 74 26 00          	lea    esi,[esi+eiz*1+0x0]
...
00001260 <__stack_chk_fail_local>:
    1260:	53                   	push   ebx
    1261:	e8 2a fe ff ff       	call   1090 <__x86.get_pc_thunk.bx>
    1266:	81 c3 9a 2d 00 00    	add    ebx,0x2d9a
    126c:	83 ec 08             	sub    esp,0x8
    126f:	e8 bc fd ff ff       	call   1030 <__stack_chk_fail@plt>
